...
urlpatterns = [
    ...
    path('ajax/load_place_types/', views.load_place_types, name='ajax_load_place_types'),
    path('ajax/load_hospitals/', views.load_hospitals, name='ajax_load_hospitals'),
    path('ajax/load_issues/', views.load_issues, name='ajax_load_issues'),
    path('ajax/load_doctors/', views.load_doctors, name='ajax_load_doctors'),
